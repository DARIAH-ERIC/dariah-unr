...
interface DashboardAdminWorkingGroupReportsPageProps extends PageProps<"/[locale]/dashboard/administrator/working-group-reports"> {}

export async function generateMetadata(
	_props: Readonly<DashboardAdminWorkingGroupReportsPageProps>,
): Promise<Metadata> {
