...
export function Input({ className, ref, ...props }: Readonly<InputProps>): ReactNode {
	return (
		<span className="relative block w-full" data-slot="control">
			<InputPrimitive
				...
				className={cx(
					...
					"invalid:border-danger-subtle-fg/70 invalid:enabled:hover:border-danger-subtle-fg/80 focus:invalid:border-danger-subtle-fg/70 focus:invalid:ring-danger-subtle-fg/20 focus:invalid:enabled:hover:border-danger-subtle-fg/80",
...
export function InputGroup({ className, ...props }: Readonly<GroupProps>): ReactNode {
	return (
		<Group
			className={cx(
				"relative isolate block",
				// icon
				"sm:has-[>[data-slot=icon]:last-child]:[&_input]:pr-8 sm:has-[>[data-slot=icon]:first-child]:[&_input]:pl-8 has-[>[data-slot=icon]:last-child]:[&_input]:pr-10 has-[>[data-slot=icon]:first-child]:[&_input]:pl-10",
				...
				// loader
				"sm:has-[[data-slot=loader]:last-child]:[&_input]:pr-8 sm:has-[[data-slot=loader]:first-child]:[&_input]:pl-8 has-[[data-slot=loader]:last-child]:[&_input]:pr-10 has-[[data-slot=loader]:first-child]:[&_input]:pl-10",
				...
				// button
				"sm:has-[>button:last-child]:[&_input]:pr-(--input-gutter-end,--spacing(14)) sm:has-[>button:first-child]:[&_input]:pl-(--input-gutter-start,--spacing(14)) has-[>button:last-child]:[&_input]:pr-(--input-gutter-end,--spacing(16)) has-[>button:first-child]:[&_input]:pl-(--input-gutter-start,--spacing(16))",
				...
				"sm:*:[button]:min-h-9 [&>button[data-intent=outline]]:border-input *:[button]:absolute *:[button]:top-0 *:[button]:z-10 *:[button]:min-h-11",
