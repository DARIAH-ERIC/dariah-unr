...
export function RangeCalendar<T extends DateValue>({
	...
	...props
}: Readonly<RangeCalendarProps<T>>): ReactNode {
									...
									return (
										<CalendarCell
											className={twMerge([
												...
												"group/calendar-cell relative size-11 cursor-default leading-[2.286rem] outline-hidden outside-month:text-muted-fg selection-start:rounded-s-lg selection-end:rounded-e-lg sm:size-9 sm:text-sm",
