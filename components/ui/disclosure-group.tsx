...
export function DisclosureGroup({
	className,
	...props
}: Readonly<DisclosureGroupProps>): ReactNode {
	return (
...
export function Disclosure({ className, ...props }: Readonly<DisclosureProps>): ReactNode {
	return (
		<PrimitiveDisclosure
...
export function DisclosureTrigger({
	...
	className,
	...props
}: Readonly<DisclosureTriggerProps>): ReactNode {
...
export function DisclosurePanel({
	className,
	...props
}: Readonly<DisclosurePanelProps>): ReactNode {
	return (
