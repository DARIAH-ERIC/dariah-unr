...
import type { ComponentPropsWithoutRef, ReactNode, RefObject, SVGProps } from "react";
import { ProgressBar } from "react-aria-components";
import { twMerge } from "tailwind-merge";

function Ring({ className, ...props }: Readonly<SVGProps<SVGSVGElement>>): ReactNode {
	return (
		<svg
...
function Spin({ className, ...props }: Readonly<SVGProps<SVGSVGElement>>): ReactNode {
	return (
...
export function Loader({
	...
	ref,
	...props
}: Readonly<LoaderProps>): ReactNode {
